...
| Commandes | Description |
| -- | -- |
| help \[Commands,\] | Affiche les différentes commandes demandées par l'utilisateur, ainsi qu'une brève explication de chacunes d'elles. Si aucune commande n'est fournie, il affiche alors toutes les commandes disponibles. |
...
| pwd | Affiche le dossier courant. |
| upload File | Envoie le fichier 'File' depuis la machine locale vers la victime. Le fichier est enregistré dans le dossier courant en conservant le même nom. |
